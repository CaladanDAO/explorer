...
function presentCurrencyID(currencyID, chainID = false) {
    return `<a href="/asset/${chainID}/${currencyID}">` + getFullHash(currencyID) + '</a>';
}
...
function launchToast(txt, title = false) {
    ...
    let toastTitle = (title) ? title : "Caladan Notification"
    toast.innerHTML = `
...
! function() {
    ...
    function o() {
        var e = c[0] ^ c[0] << 11;
        return c[0] = c[1], c[1] = c[2], c[2] = c[3], c[3] = c[3] ^ c[3] >> 19 ^ e ^ e >> 8, (c[3] >>> 0) / (1 << 31 >>> 0)
    }
    ...
    function t(e) {
        for (var r = e, t = e, l = Math.ceil(r / 2), n = r - l, a = [], c = 0; t > c; c++) {
    ...
    function l(o) {
        var t = {};
        return t.seed = o.seed || Math.floor(Math.random() * Math.pow(10, 16)).toString(16), e(t.seed), t.size = o.size || 8, t.scale = o.scale || 4, t.color = o.color || r(), t.bgcolor = o.bgcolor || r(), t.spotcolor = o.spotcolor || r(), t
    }
    ...
    function n(e, o) {
        ...
        n.fillStyle = e.bgcolor, n.fillRect(0, 0, o.width, o.height), n.fillStyle = e.color;
